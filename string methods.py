...
print(string.center(120,"*")) #moves the string to the right by 120 px and fill the empty space by the character you provide
print(string.count("allah",0,20)) #counts the no. of times "Allah" appears in the string. NOte: case sensitive, returns 0 for allah. searches from index 0 to 20

price=34
apple="buy an apple for only {price:.4f} rupees."
print(apple.format(price=35)) #Insert the price inside the placeholder, the price should be in fixed point, two-decimal format:
