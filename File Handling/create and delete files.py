...
# note: removes only if the folder is empty, and throws error if folder doesn't esist


# to avoid an error, check the file if it exist before attempting to delete it.
if os.path.exists("newFile2"):
    print("yes the File exists, let me delete it.")
    os.remove("newFile2")
